...
export default function Hero({ stats }) {
  return (
    <div className="relative h-min-screen bg-zinc-900">
      ...
      {/* Content overlay */}
      <div className="relative container mx-auto px-10 pt-40 pb-20 min-h-screen flex flex-col justify-center items-center text-center">
        <div className="max-w-3xl">
          ...
          <div className="">
            <Button size="lg" className="bg-[#BA0A0A] hover:bg-red-500 text-white rounded-full">
              Get Started
            </Button>
          </div>
        </div>
